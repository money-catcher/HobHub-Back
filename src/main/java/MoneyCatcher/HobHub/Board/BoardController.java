...
public class BoardController {
    ...
    public ResponseEntity<String> save(@PathVariable Long userId, @PathVariable Long hobbyId, @RequestBody BoardEntity boardEntity) throws IOException//하나의 객체로 입력값 가져오기
    {
        ...
        boardEntity.setHobby(hobby); // 게시물이 속하는 취미 설정
        hobby.getBoardEntityList().add(boardEntity); // 취미에 게시물 추가
        boardRepository.save(boardEntity); // 게시물 저장
